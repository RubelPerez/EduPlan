...
public class PrimerGradoSecundaria extends AppCompatActivity {
public EditText btn1,btn2,btn3,btn4,btn5,btn6,btn7,btn8,btn9;
public int btnID;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_primer_grado_secundaria);
        ...
        btn1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                btnID=1;
                Intent intent = new Intent(PrimerGradoSecundaria.this,PrimerGradoSecundariaTemplate.class);
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent atras = new Intent(PrimerGradoSecundaria.this,PrimerCicloSecundaria.class);
